...
function mapCustomer(row: Row): Customer {
  return {
    ...
    verificationTokenHash: (row.verification_token_hash as string | null) ?? null,
    verificationSentAt: (row.verification_sent_at as string | null) ?? null,
    verificationExpiresAt: (row.verification_expires_at as string | null) ?? null,
    verificationTokenUsedAt: (row.verification_token_used_at as string | null) ?? null,
    verifiedIp: (row.verified_ip as string | null) ?? null,
    verifiedUserAgent: (row.verified_user_agent as string | null) ?? null,
